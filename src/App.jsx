          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center lg:px-[70px] flex-wrap flex-col sm:flex-row mx-[-12px] mt-[20px] lg:mt-[30px]">
              {icons.map((item, index) => (
                <div key={index} className="w-full lg:w-4/12 xl:w-3/12 md:w-4/12 sm:w-6/12 px-3 mt-[20px] lg:mt-[30px]">
          ...
          <div className="xl:max-w-[1360px] container mx-auto px-4 lg:px-10">
            ...
            <div className="flex flex-wrap justify-center  lg:justify-between lg:gap-0 mt-3 lg:mt-[30px]">
              {TechExperts.map((item, index) => (
                ...
                >
                  <div className="bg-green-500 group overflow-hidden rounded-[13px] hover:bg-red-600 transition-colors duration-300 mt-5">
            ...
            <div className="xl:max-w-[1360px] container mx-auto px-4 lg:px-10 ">
              <div className="text-center">
                ...
                <p className="text-[12px] lg:text-[14px] font-inter text-[#00000099] w-[90%]  mt-[10px]  xl:mt-[30px] lg:max-w-[53%] mx-auto">
                  Our Courses are meticulously crafted with insights from
                  numerous job descriptions and industry experts, ensuring you
                  acquire skills relevant to the current job market.
                </p>
              </div>
    ...
    <div className="w-[1360] mx-auto px-4 lg:px-10">
        <div>
            ...
            <p className="text-[12px] lg:text-[14px] font-inter lg:leading-[16px] text-[#00000099] mt-2 xl:mt-[30px] w-full sm:w-[50%] lg:w-[35%]">
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard Lorem
            </p>
        </div>
       
            <div className="grid_container">
                <div className="item1">
                    <img src={Projectimg1} alt="Project Image" className="w-full h-[470px] object-cover" />
                ...
                <div className="item2">
                    <img src={Projectimg2} alt="Project Image" className="w-full h-[373px] object-cover" />
                    <div className="py-[14px]">
                        <button className="text-white text-[12px] lg:text-[14px] font-inter font-medium  bg-[#C04000] py-[5px] px-[10px] rounded-md  hover:bg-orange-700">
                            Namo Prime Services
                        </button>
                ...
                <div className="item3">
                    <img src={Projectimg3} alt="Project Image" className="w-full h-[470px] object-cover" />
                    <div className="py-[14px]">
                        <button className="text-white text-[12px] lg:text-[14px] font-inter font-medium  bg-[#C04000] py-[5px] px-[10px] rounded-md  hover:bg-orange-700">
                            Namo Prime Services
                        </button>
                ...
                <div className="item4">
                    <img src={Projectimg4} alt="Project Image" className="w-full h-[373px] object-cover" />
                    <div className="py-[14px]">
                        <button className="text-white text-[12px] lg:text-[14px] font-inter font-medium  bg-[#C04000] py-[5px] px-[10px] rounded-md  hover:bg-orange-700">
                            Namo Prime Services
                        </button>
                ...
                <div className="item5">
                    <img src={Projectimg1} alt="Project Image" className="w-full h-[532px] object-cover" />
                    <div className="py-[14px]">
                        <button className="text-white text-[12px] lg:text-[14px] font-inter font-medium  bg-[#C04000] py-[5px] px-[10px] rounded-md  hover:bg-orange-700">
                            Namo Prime Services
                        </button>
                ...
                <div className="item6">
                    <img src={Projectimg6} alt="Project Image" className="w-full h-[373px] object-cover" />
                    <div className="py-[14px]">
                        <button className="text-white text-[12px] lg:text-[14px] font-inter font-medium  bg-[#C04000] py-[5px] px-[10px] rounded-md  hover:bg-orange-700">
                            Namo Prime Services
                        </button>
        ...
        <section className="bg-Business-Coaching bg-cover py-[50px] lg:py-[100px]">
          <div className="xl:max-w-[1360px] container mx-auto px-4 lg:px-10  ">
           ...
           <div className="py-[25px] lg:py-[40px]">
           <Accordions/>
           </div>
          </div>
        </section>
